...
BRAILLE_CLUEPHRASE = "EXCELLENT WORK NOW DECODE THESE TONES USING NTH PIANO KEY AS ASCII"

# cannot contain Y or Z
NOTES_CLUEPHRASE =   "SHIFT DOWN EXTRA NOTES TO CREATE FAMOUS TUNE FROM DEAF COMPOSERS 9TH SINFONIA STARTING ON MIDDLE C. THEN DECODE SHIFTS AS LETTERS"
...
FINAL_SOLUTION = "HEREISAFINALSOLUTIONCLUEPHRASE"
